...
const Footer = () => {
    return (
        <footer className="px-4 divide-y dark:bg-gray-800 dark:text-gray-100">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <Link rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                        <div className="flex items-center justify-center w-12 h-12 rounded-full dark:bg-yellow-400">

                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 25 26" strokeWidth={1.5} stroke="currentColor" className="flex-shrink-0 w-5 h-5 rounded-full dark:text-gray-900">
                                <path strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 32 32" fill="currentColor" d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.8m5.84-2.58a14.98 14.98 0 006.16-12.12A14.98 14.98 0 009.631 8.41m5.96 5.96a14.926 14.926 0 01-5.841 2.58m-.119-8.54a6 6 0 00-7.381 5.84h4.8m2.581-5.84a14.927 14.927 0 00-2.58 5.84m2.699 2.7c-.103.021-.207.041-.311.06a15.09 15.09 0 01-2.448-2.448 14.9 14.9 0 01.06-.312m-2.24 2.39a4.493 4.493 0 00-1.757 4.306 4.493 4.493 0 004.306-1.758M16.5 9a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z" />
                            </svg>

                        </div>
                        <span className="self-center text-2xl font-semibold">ISP Review</span>
                    </Link>
                </div>
            ...
            <div className="py-6 text-sm text-center dark:text-gray-400">©Rayhan 2022 Company Co. All rights reserved.</div>
        </footer>
    );
};
