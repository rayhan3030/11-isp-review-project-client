...
const SecondSectionGif = () => {
    return (
        <div>
            <section className="py-6 dark:bg-yellow-500 dark:text-black">
                <div className="container p-4 mx-auto space-y-16 sm:p-10">
                    <div className="space-y-4">
                        <h3 className="text-2xl font-bold leading-none sm:text-5xl">Meet ISP Review team</h3>
                        <p className="max-w-2xl dark:text-black">We are reviewing today Carnival Internet Packages.</p>
                    </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                <div className="flex mt-2 space-x-2">
                                    <Link rel="noopener noreferrer" href="#" title="Twitter" className="dark:text-gray-400">
                                    ...
                                    <Link rel="noopener noreferrer" href="#" title="LinkedIn" className="dark:text-gray-400">
                                    ...
                                    <Link rel="noopener noreferrer" href="#" title="GitHub" className="dark:text-gray-400">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-4 h-4">
...
export default SecondSectionGif;